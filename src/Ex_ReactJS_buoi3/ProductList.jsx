    ...
    return (
      <div className="cartCount">
        ...
        <div className="container">
          ...
          <hr className="mt-5 border border-2 border-danger" />
          <div className="mt-5">
            <div className="row">
              <div className="col-12 col-md-4">
                <h3 className="fs-1 fw-bold text-center py-2">{tenSP}</h3>
                <img
                  src={hinhAnh}
                  alt="..."
                  height={350}
              ...
              <div className="col-8 mx-auto px-5">
                <h3 className="fs-1 fw-bold py-2">Thông tin chi tiết</h3>
